              ...
              <TransitionGroup>
                <CSSTransition key={location.key} classNames="fade" timeout={300}>
                  <Switch location={location}>
                    ...
                    <RoutesAuthenticated exact name="contact list" path="/contacts-list/:platform" component={ContactsList} onSetOpen={this.onSetSidebarOpen} open={this.state.sidebarOpen} {...this.props}/>
